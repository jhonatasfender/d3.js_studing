    ...
    var form = {
        ...
        u = {
            ...
            getScreenSize: function () {
                ...
                if (u.config.screenSize == undefined) { 
                    return {
                        x: x,
                        y: y
                    };
            ...
            ready: function (error, shp) {
                ...
                for(var j in shp.objects) {
                    ...
                    var offset = [(u.getScreenSize().x - (bounds[0][0] + bounds[1][0]) / 2), (u.getScreenSize().y - (bounds[0][1] + bounds[1][1]) / 2)];
                    u.projection = d3.geoMercator()
                        .center(center)
                        .scale(scale)
                        .translate(offset);
